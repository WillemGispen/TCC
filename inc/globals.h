...
int do6A, do6Z, do7B, do7K, do7T_a, do7T_s;
int do8A, do8B, do8K;
int do9A, do9B, do9K;
...
int n6A, n6Z, n7B, n7K, n7T_a, n7T_s;
int n8A, n8B, n8K;
int n9A, n9B, n9K;
...
int m6A, m6Z, m7B, m7K, m7T_a, m7T_s;
int m8A, m8B, m8K;
int m9A, m9B, m9K;
...
int **hc6A, **hc6Z, **hc7B, **hc7K, **hc7T_a, **hc7T_s;
int **hc8A, **hc8B, **hc8K;
int **hc9A, **hc9B, **hc9K;
...
char *s6A, *s6Z, *s7B, *s7K, *s7T_a, *s7T_s;
char *s8A, *s8B, *s8K;
char *s9A, *s9B, *s9K;
